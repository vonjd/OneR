...
#' @details Error rate reduction versus the base rate accuracy is calculated by the following formula: \eqn{(Accuracy(Prediction) - Accuracy(Baserate)) / (1 - Accuracy(Baserate))}, giving a number between 0 (no error reduction) and 1 (no error).
